...
This mod improves combat experience in Stardew Valley by increasing player mobility while using weapons or tools.

## ❤️ Key Features

- Allow movement while using weapons or tools (can be enabled/disabled separately for weapons and tools).
- Face the mouse cursor while attacking.
...
- `FaceMouseWhenAttack` (bool) - Face the mouse when attacking (default: true).
- `WeaponAutoswing` (bool) - Enable weapon autoswing (default: true).
- `EnableForWeapons` (bool) - Allow movement while using weapons (default: true).
- `EnableForTools` (bool) - Allow movement while using tools (default: true).
